...
const Orders = () => {
  ...
  const fetchOrders = async () => {
    ...
    try {
      setLoading(true);
      const response = await axios.get(`${USER_BASE_URL}/api/order/getall`, {
  ...
  const handleStatusUpdate = async (orderId, newStatus) => {
    try {
      const response = await axios.put(
        `${USER_BASE_URL}/api/order/updatestatus/${orderId}`,
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-900">
                        ...
                        {selectedOrder.apt || "Not provided"} {", "}
                        {selectedOrder.city || "Not provided"} {", "}
                        {selectedOrder.state || "Not provided"} {", "}
                        {selectedOrder.postalCode || "Not provided"}
                      </p>
                    </div>
                    <div>
