const ReturnPolicyPage = () => {
  return (
    <>
      <div className="px-4 pt-12 pb-16 container mx-auto">
        <h1 className="text-3xl font-semibold mb-2">Return Policy</h1>
        <p className="text-sm text-gray-500 mb-6">Home / Return Policy</p>

        <div className="space-y-6 text-gray-700 md:text-lg xl:text-xl">
          <p>
          ...
          <div>
            ...
            <p>
              ...
              been 'less and less and less'. I have found that the pieces I
              reach for years after purchase, are the classic shapes in high
              quality fabrics. I wanted to create a brand that designs by these
