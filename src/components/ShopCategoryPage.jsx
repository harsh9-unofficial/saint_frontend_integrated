...
export default function ShopCategoryPage() {
  ...
  useEffect(() => {
    ...
    fetchData();
  }, [category]); // Add category as a dependency to re-run when it changes

  // Define displayCategory
  ...
  const filteredProducts = products.filter((product) => {
    ...
    // Apply category filter based on URL parameter only
    ...
    return (
      matchesSearch && matchesCategory && matchesColor && matchMin && matchMax
    );
  });
